...
<p>Other tools like <b style='color:white;'>Light Pollution Map</b>, <b style='color:white;'>NASA Worldview</b>, and <b style='color:white;'>Globe at Night</b> show raw radiance data or static snapshots. They are built for researchers.</p>
<p>This tool does something none of them do — it translates light pollution data into <b style='color:white;'>human terms</b>. Not numbers. Stars. The ones you have actually lost from your specific sky, by name.</p>
<p style='text-align:center; color:#555577; font-size:12px;'>Built by a student researcher in San Diego using real NASA Black Marble VNP46A4 satellite data</p>
</div>
""", unsafe_allow_html=True)
